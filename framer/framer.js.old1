...
/***/ function(module, exports, __webpack_require__) {
	...
	Framer.Debug = (__webpack_require__(49)).Debug;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Animation, BaseClass, Color, Config, Defaults, EventEmitter, Events, GestureManager, LayerDraggable, LayerStates, LayerStyle, Matrix, NoCacheDateKey, Utils, _, layerProperty, layerValueTypeError,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty,
	  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
	...
	GestureManager = __webpack_require__(34).GestureManager;
...
/***/ function(module, exports, __webpack_require__) {
	...
	GestureManagerElement = __webpack_require__(34).GestureManagerElement;
...
/***/ function(module, exports) {
	...
	exports.date = 1453119007;
	
	exports.branch = "master";
	
	exports.hash = "325775b";
